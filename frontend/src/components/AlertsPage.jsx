            ...
            setAlerts([
              {
                ...
                type: 'success',
                product_url: 'https://www.amazon.in/dp/B0CHX2T5S5'
              },
              {
                id: 's2',
                ...
                type: 'info',
                product_url: 'https://www.apple.com/in/shop/buy-mac/macbook-air/m3-chip'
              },
              {
                id: 's3',
            ...
            {alerts.map((alert, idx) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button 
                    onClick={() => alert.product_url && window.open(alert.product_url, '_blank')}
                    className={`flex-1 md:flex-none px-6 py-3 font-bebas text-xl border-[2px] border-[var(--neo-border)] shadow-[3px_3px_0_0_var(--neo-shadow)] transition-all ${
                      alert.type === 'warning' 
                        ? 'bg-[#1A1A1A] text-white hover:bg-slate-800' 
                        : 'bg-[var(--neo-green)] text-[#1A1A1A] hover:bg-[var(--neo-yellow)]'
                    }`}
                  >
                    VIEW DEAL
                  </button>
